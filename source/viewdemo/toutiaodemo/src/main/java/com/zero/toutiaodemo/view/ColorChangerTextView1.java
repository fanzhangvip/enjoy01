...
public class ColorChangerTextView1 extends View {
...
//        <attr name="direction"/>
    ...
    public ColorChangerTextView1(final Context context) {
        super(context);
        init();
    }

    public ColorChangerTextView1(final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
        init();
        initAttrs(context,attrs);
    }

    public ColorChangerTextView1(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
        initAttrs(context,attrs);
    }

    public ColorChangerTextView1(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
