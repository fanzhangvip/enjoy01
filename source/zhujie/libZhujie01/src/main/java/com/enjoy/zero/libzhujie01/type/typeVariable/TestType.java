package com.enjoy.zero.libzhujie01.type.typeVariable;
...
//        Assert.assertEquals(fk.getGenericType() instanceof TypeVariable, "必须为TypeVariable类型");
//        Assert.assertEquals(fv.getGenericType() instanceof TypeVariable, "必须为TypeVariable类型");
